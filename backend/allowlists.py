"""
Allowlists for valid GT7 cars and tracks.
These mirror the frontend src/data/cars.js and src/data/tracks.js exactly.
The backend validates incoming requests against these to prevent injection.
"""
